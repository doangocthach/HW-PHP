    ...
    <div class="footer">
        <div class="container">
            <div class="wraper">
                ...
                <form method="POST" class="form-control flex">
                    <div>
                        <input type="email" placeholder="Địa chỉ email của bạn" class="tiki-home-email" id="mce-EMAIL">
                        <span class="error-news">Email rỗng hoặc không hợp lệ, vui lòng kiểm tra lại!</span>
                    </div>
                    <div>
    ...
    <div class="btm-footer container">
        <div class="btm left">
           ...
           <i class="tiki-icon-pay loaction"></i>
            ...
            <p class="loction-content">Tiki nhận đặt hàng trực tuyến và giao hàng tận nơi, chưa hỗ trợ mua và nhận hàng
    ...
    <div class="btm-footer container">
       ...
       <div class="Notarized">
         ...
         <div class="gg">
            <img src="../body/img/216e535ff06b1b925796957a017cbedb.png" height="36px" alt="ok">
